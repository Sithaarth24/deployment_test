...
end_lat, end_lon = 13.740423, 60.260764 # Replace with your end coordinates
t = time.time()
(path_lat_lon1) = grid.a_star(start_lat, start_lon, end_lat, end_lon)
print("time taken",time.time() - t)
# print("lenth",len(traversed1))
# time taken 15.852512121200562
# lenth 334086

# time taken 16.062925100326538
# lenth 331276
# with open('path.csv' , 'w') as f:
#     for i in path_lat_lon:
#         s = str(i[0]) + "," + str(i[1]) +"\n"
#         f.write(s)
plot_path_on_map(path_lat_lon1)
